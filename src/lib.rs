...
#[derive(Debug)]
pub struct BlockSageProcessor {
    verbose: bool,
    processed_count: usize,
}

impl BlockSageProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting BlockSage processing");
    
    let mut processor = BlockSageProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = BlockSageProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = BlockSageProcessor::new(false);
